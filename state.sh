...
input3='{"path":"createStation","payload":{"owner":"stationOwner01","consumption":100,"price_per_credit":50,"latitude":40.7128,"longitude":-74.0060}}'
input4='{"path":"createStation","payload":{"owner":"stationOwner02","consumption":100,"price_per_credit":10,"latitude":40.7128,"longitude":-74.0060}}'
...
expires_at=$(($(date +%s) + 5))
input10=$(printf '{"path":"createAuction","payload":{"price_limit_per_credit":"1000","expires_at":%d,"orders_time_range":%d}}' "$expires_at" 2)

input11='{"path":"createBid","payload":{"price_per_credit":"100"}}'
input12='{"path":"createBid","payload":{"price_per_credit":"500"}}'
input13='{"path":"createBid","payload":{"price_per_credit":"200"}}'
input14='{"path":"createBid","payload":{"price_per_credit":"300"}}'
input15='{"path":"createBid","payload":{"price_per_credit":"200"}}'
